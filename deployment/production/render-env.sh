...
append AUTO_INDEX_ON_STARTUP "${AUTO_INDEX_ON_STARTUP:-0}"
...
append RAG_MAX_TOTAL_CONTEXT_CHARS "${RAG_MAX_TOTAL_CONTEXT_CHARS:-3600}"
append RAG_MAX_HISTORY_MESSAGES "${RAG_MAX_HISTORY_MESSAGES:-5}"
append RAG_MAX_HISTORY_CHARS "${RAG_MAX_HISTORY_CHARS:-1600}"
append RAG_SOURCE_SNIPPET_CHARS "${RAG_SOURCE_SNIPPET_CHARS:-320}"
